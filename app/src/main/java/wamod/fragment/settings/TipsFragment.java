...
public class TipsFragment extends PageFragment {

    public static PageFragment create(HomePageFragment homePageFragment) {
        TipsFragment privacyFragment = new TipsFragment();
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup) {
        ...
        mRootView = layoutInflater.inflate(Resources.getLayout(mHomeActivity, "wamod_settings_tips"), null);
